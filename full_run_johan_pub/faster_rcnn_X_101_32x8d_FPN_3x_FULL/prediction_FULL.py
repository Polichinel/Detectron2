...
cfg_pkl_path = '/home/projects/ku_00017/people/simpol/scripts/bodies/Detectron2/full_run_no_test/faster_rcnn_X_101_32x8d_FPN_3x_FULL/faster_rcnn_X_101_32x8d_FPN_3x_FULL.pkl' # path to the config file you just created
model_name = "faster_rcnn_X_101_32x8d_FPN_3x_FULL"
...
img_dir = '/home/projects/ku_00017/data/raw/bodies/published_spanner'
...
location = f'/home/projects/ku_00017/data/generated/bodies/sample_pred_pub_img/{model_name}' # full is in model name here...
os.makedirs(location, exist_ok = True)

# A bit overkill, but nice for checking errors down the line.
with open(location + '/instances_list_FULL.pkl', 'wb') as file:
    pickle.dump(instances_list, file)

#instances_list_location = location + 'instances_list_FULL.pkl'
with open(location + '/output_list_FULL.pkl', 'wb') as file:
    pickle.dump(output_list, file)

with open(location + '/all_img_feature_list_FULL.pkl', 'wb') as file:
