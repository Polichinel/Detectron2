...
cfg_pkl_path = 'faster_rcnn_R_101_FPN_3x_FULL.pkl' # path to the config file you just created
model_name = "faster_rcnn_R_101_FPN_3x_FULL"
...
location = f'/home/projects/ku_00017/data/generated/bodies/detectron_outputs/{model_name}' # full is in model name here
