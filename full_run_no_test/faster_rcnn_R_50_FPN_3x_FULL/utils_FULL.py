...
def get_img_dicts(img_dir):
    ...
    for filename in annotation_list: # you should be able to just do "for file name in annotation_list" when using all data.
...
# CHANGED FOR FULL RUN - so no testing here!!!
...
class MyTrainer(DefaultTrainer):
    ...
    #     # --------------------
    #     cfg_pkl_path = 'faster_rcnn_R_50_FPN_3x.pkl' # path to the config file you just created
